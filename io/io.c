...
const char GROUP_FORMAT_NAMES[][MAXTAGLEN] = {"subfind_binary", "hinge_ascii", "hinge_binary"};
const enum valid_group_formats GROUP_FORMAT_ENUMS[] = {subfind_binary, hinge_ascii, hinge_binary};
