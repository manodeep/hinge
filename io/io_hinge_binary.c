...
#define PREAD_UNTIL_DONE(fd, buf, total_bytes, offset)                                                                 \
    ...
    XASSERT(sizeof(group->x[0]) == sizeof(group->y[0]),
            "Error: sizeof(group->x[0]) = %zu != sizeof(group->y[0]) = %zu\n", sizeof(group->x[0]),
            sizeof(group->y[0]));
    XASSERT(sizeof(group->x[0]) == sizeof(group->z[0]),
