...
const char modelnames[][MAXLEN] = {
    "Conroy & Wechsler (2009)", "Moster et al (2010)", "Behroozi et al (2010)",
    "Behroozi et al (2013)"};
...
int main(int argc, char **argv) {
  ...
  int output_table = 0;
  if (argc < 4) {
    fprintf(stderr, "ERROR: Supply <Mvir, Msun/h>  <model> <Table output (> 0 "
                    "if a table of Mhalo, Mstellar is desired> [z]\n");
